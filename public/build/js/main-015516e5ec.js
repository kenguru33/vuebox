        ...
        onFileSelect: function onFileSelect(e) {
            ...
            _papaparse2.default.parse(file, {
                complete: function complete(results) {
                    _this.header = results.data.shift();
                    _this.rows = results.data;
                }
            });
        }
    },
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  if (!module.hot.data) {
    hotAPI.createRecord("_v-642c73ac", module.exports)
  } else {
    hotAPI.update("_v-642c73ac", module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
  }
})()}
},{"papaparse":1,"vue":4,"vue-hot-reload-api":3,"vueify/lib/insert-css":5}],7:[function(require,module,exports){
'use strict';
...
var _CsvParser = require('./Components/CsvParser.vue');
...
var myVue = new _vue2.default({
    el: '#app',
    components: { CsvParser: _CsvParser2.default }
});

},{"./Components/CsvParser.vue":6,"vue":4}]},{},[7]);
